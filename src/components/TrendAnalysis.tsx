...
const TrendAnalysis: React.FC<TrendAnalysisProps> = ({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* Compact header */}
      {title && (
        <h3 className="px-1 py-0 text-[9px] font-medium bg-gray-50 leading-tight">{title}</h3>
      )}
      {/* Chart area: remove extra padding, set min-h-[120px] for clarity */}
  ...
  wrapperStyle={{
    zIndex: 50,                 // <-- ensure tooltip wrapper is above
  }}
/>
            {/* <Legend
              align="right"
            ...
            <Line
              ...
              stroke="#3182ce"
              strokeWidth={2}
              dot={{ r: 2.5, strokeWidth: 1, fill: '#fff' }}
              activeDot={{ r: 5 }}
              name="Actual"
            />
            <Line
            ...
            {simulatedActualValues.length > 0 && (
              <Line
                ...
                strokeDasharray="5 3"
                strokeWidth={2}
                dot={{ r: 2.5, strokeWidth: 1, fill: '#06b6d4' }}
                activeDot={{ r: 5 }}
                name="Business Potential"
              />
            )}
            {simulatedTargetValues.length > 0 && (
              <Line
                ...
                strokeDasharray="5 3"
                strokeWidth={2}
                dot={{ r: 2.5, strokeWidth: 1, fill: '#a855f7' }}
                activeDot={{ r: 5 }}
                name="Simulated Target"
              />
            )}
            {simulatedIndustryValues && simulatedIndustryValues.length > 0 && (
              <Line
                ...
                strokeDasharray="5 3"
                strokeWidth={2}
                dot={{ r: 2.5, strokeWidth: 1, fill: '#6366f1' }}
                activeDot={{ r: 5 }}
                name="Projected Industry Average"
              />
            )}
